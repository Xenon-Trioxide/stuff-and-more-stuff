...
--[[
	DEXploit (working decompiler?)
	Original Dex developed by Moon
	Modified for XploitSDS Usage
...
local decompiler = loadstring(game:HttpGet("https://raw.githubusercontent.com/Xenon-Trioxide/stuff-and-more-stuff/main/GPTDecompiler.lua"))()
...
Main = (function()
	...
	Main.Error = function(str)
		if rconsoleprint then
			rconsoleprint("DEXploit ERROR: "..tostring(str).."\n")
			wait(9e9)
		else
			error(str)
		end
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="DEXploit",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Modified by XploitSDS",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
